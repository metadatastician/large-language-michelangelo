...
1. Navigate to [Report a Vulnerability](https://github.com/metadatastician/large-language-michelangelo/security/advisories/new)
...
- This repository (`metadatastician/large-language-michelangelo`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/metadatastician/large-language-michelangelo/security/advisories)
...
When using large-language-michelangelo, we recommend:
...
- [Security Advisories](https://github.com/metadatastician/large-language-michelangelo/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/metadatastician/large-language-michelangelo/security/advisories/new) or j.d.a.jewell@open.ac.uk |
| **General questions** | [GitHub Discussions](https://github.com/metadatastician/large-language-michelangelo/discussions) |
...
*Thank you for helping keep large-language-michelangelo and its users safe.* 🛡️
